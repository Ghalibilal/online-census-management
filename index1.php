    ...
    <ul class="dropdown-menu" role="menu" >
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <div class="container" id="body">
          ...
          <p style='color:green;'>The census organization was established in 1950 as a part 
           ...
           <h3 style='color:green;'>History of Census </h3>
            <p style='color:green;'>Pakistan has a long history of Census taking and the first regular Population Census<br>
             in the area now comprising Pakistan<br>
              was held in 1881. Since then regular censuses
               have been conducted after every ten years <br>
               in the year ending at one. After independence,
                the first census of Pakistan was conducted in 1951,<br>
                 the second in 1961 while the third census was held
                  in 1972 instead of 1971 due to political environment <br>
                  in the country and war with India.
                   The fourth census was held in March 1981 and fifth<br>
...
(b) De-fecto– in which persons are counted where they are found on the census data.<br> In 1998 census both the approaches were applied simultaneously during enumeration, but the data was tabulated and published on de-jure basis for comparability of data over time.</p>
