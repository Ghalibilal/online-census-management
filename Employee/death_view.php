  ...
  <h5 style='color:green;text-align:center;'>Death Information</h5>
    ...
    <?php
     ...
     $cnic=$_SESSION['login_user'];
      ...
      $sql = "SELECT *
FROM death WHERE emp_id='$emp_id'";
$result = mysqli_query($conn, $sql);
...
?></td>
      ...
      <td><a class='btn btn-danger' href="familyDetail/birth_delete.php?id=<?php echo $id;?>"  onclick='return confirm("Are you sure to delete");'>Delete</a></td>
      </tr>
      <?php     }
} else {
    echo "0 results";
