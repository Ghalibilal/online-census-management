    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="../people_view.php">View Family</a></li>
         <li ><a href="individual_form.php" >Add Individual</a></li>
        <li class='active'><a href="#">View Individual</a></li>
...
<div class="container_fluid " style='margin-left:120;'>
  <h5 style='color:green;' class='text-center'> INDIVIDUAL PEOPLE</h5>
  
  <div class='col-sm-1'></div>
  <div class='col-sm-10'>
    <form class="navbar-form navbar-left" method='post' action="../search/search_individual.php">
    ...
    <input type='submit' class='btn btn-primary' name='submit' value='search'>
      ...
      <table class="table table-striped  table-bordered text-capitalize bg-success">
    <thead>
    ...
    <?php
     ...
     $cnic=$_SESSION['login_user'];
      ...
      $sql = "SELECT people.*
FROM people
INNER JOIN individual ON people.serial_no=individual.individual_id AND people.emp_id='$emp_id' order by people.serial_no LIMIT ".$page1.",5";
$result = mysqli_query($conn, $sql);
...
?></td>
    ...
    <ul class="dropdown-menu">
      <li><a class='btn btn-info' href="../management/change_death_individual.php?id=<?php echo $id;?>"><b>Change to death</b></a></li>
      <li><a class='btn btn-danger' href="../management/Delete_individual.php?delete=<?php echo $id;?>"  onclick='return confirm("Are you sure to delete");'>Delete</a></li>
       <li><a class='btn btn-danger' href="../management/make_head.php?change_id=<?php echo $id;?>">Make Head</a></li>
        <li><a class='btn btn-danger' href="../management/make_familyIndividual.php?change_id=<?php echo $id;?>">Make Family</a></li>
      
    </ul>
  </div>
</div>
</td>
        <td><a class="btn btn-primary" href="../edit/edit_individual.php?edit_h=<?php echo $row['serial_no'];?>">Edit</a></td>
...
?>
 ...
 $sql = "SELECT people.*
FROM people
INNER JOIN individual ON people.serial_no=individual.individual_id AND people.emp_id='$emp_id' ";
